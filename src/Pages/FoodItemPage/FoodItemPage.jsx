...
import { addCart, setSelectedTab } from "../../Redux/feature/cartProductSlice/cartProductSlice";
...
const FoodItemPage = () => {
    ...
    const { selectedTab } = useSelector((state) => state.cartProductSlice)
    //console.log(cartItem)


    const dispatch = useDispatch()

    const { data: menuData, isLoading, error,refetch, } = useGetMenuItemQuery(selectedTab)
        ...
        <div className="">
            ...
            <div >
                <div>
                    ...
                    <a onClick={()=>tabHandler('all')} className={selectedTab=='all'?'tab  hover:text-white bg-orange-400 duration-200 text-white':'tab text-black hover:text-white hover:bg-orange-400 duration-200 ' }>All</a>
                        <a onClick={()=>tabHandler('Pizza')} className={selectedTab=='Pizza'?'tab  hover:text-white bg-orange-400 duration-200 text-white':'tab text-black hover:text-white hover:bg-orange-400 duration-200 ' }>Pizza</a>
                        <a onClick={()=>tabHandler('Burger')} className={selectedTab=='Burger'?'tab text-white hover:text-white bg-orange-400 duration-200':'tab text-black hover:text-white hover:bg-orange-400 duration-200 ' }>Burger</a>
                        <a onClick={()=>tabHandler('Rice')} className={selectedTab=='Rice'?'tab text-white hover:text-white bg-orange-400 duration-200':'tab text-black hover:text-white hover:bg-orange-400 duration-200 ' }>Rice</a>
                    </div>
                </div>
                {isLoading ?
                    <div>
