                        ...
                        <div className='flex justify-center '>
                            <div className='grid gap-5 lg:grid-cols-2 items-center  '>
                                <div className='flex justify-center rounded-2xl border-2 border-orange-400 p-2'>
                                    <img className='max-w-[240px] sm:max-w-[300px] md:max-w-[340px] rounded-2xl' src={user?.photoURL || defaultPic} alt="" />
                                </div>
                                <div className='flex flex-col items-center mx-2'>

                                    <div className='flex gap-2 items-center my-2  w-full max-w-md '>
                                        <h1 className='text-orange-400 font-bold w-[80px] '>Name:</h1>
                                        <p className='input font-bold input-sm input-bordered w-full  '>{user?.displayName}</p>
                                    </div>
                                    <div className='flex gap-2 items-center my-2 w-full max-w-md'>
                                        <h1 className='text-orange-400 font-bold  w-[80px]'>Email:</h1>
                                        <p className='input font-bold input-sm input-bordered w-full '>{user?.email}</p>
                                    </div>
                                    <div className='flex gap-2 items-center my-2 w-full max-w-md'>
                                        <h1 className='text-orange-400 font-bold   w-[80px]'>Address:</h1>
                                        <p className='input font-bold input-sm input-bordered w-full  '>{userInfo?.address || 'add Address'}</p>
                                    </div>
                                    <div className='flex gap-2 items-center my-2 w-full max-w-md'>
                                        <h1 className='text-orange-400 font-bold  w-[80px]'>Mobile:</h1>
                                        <p className='input font-bold input-sm input-bordered w-full  '>{userInfo?.mobile || 'add Mobile'}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
