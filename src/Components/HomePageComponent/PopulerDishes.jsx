            ...
            <div className='flex justify-center  '>
                <div className=' my-10 grid gap-5 md:gap-20 grid-cols-1 sm:grid-cols-2   lg:grid-cols-4'>
                    ...
                    {!data ?
                        ...
                        :
                        <>{
                            data?.map(item => <div key={item?._id} className="card w-72 h-[450px]  custom2  bg-base-100 shadow-xl">
                                ...
                                <div className="card-body   ">
                                    ...
                                    <p>{item?.ingredients.length > 80 ? `${item?.ingredients.slice(0, 80)} ...` : item?.ingredients}</p>
