...
const ProductCart = () => {
    ...
    return (
        <div className='min-h-[400px] max-h-screen w-96 fixed top-0 right-0 z-10 shadow-2xl backdrop-blur-2xl backdrop-brightness-50 overflow-auto rounded-xl'>
            ...
            <div className='m-2 text-white min-h-[400px]'>
                {
            ...
            <div className='  flex justify-center my-3'>
                <Link to='/checkout' className='text-green-500 font-bold  hover:link-hover hover:text-white flex items-center'> CheckOut <span className='text-sm'> <FaArrowRight></FaArrowRight></span>  </Link>
            </div>
        </div>
    );
};
